...
function alquiler(tipoVehiculo, cantDias, sillaBebe){
    ...
    if(sillaBebe){
        ...
        return "Estimado cliente: en base al tipo de vehículo " + tipoVehiculo + " alquilado, considerando los " + cantDias + " días utilizados y la silla para bebé, el monto total a pagar es de $"+ total;

    }

    return "Estimado cliente: en base al tipo de vehículo " + tipoVehiculo + " alquilado, considerando los " + cantDias + " días utilizados, el monto total a pagar es de $"+ total;
}
