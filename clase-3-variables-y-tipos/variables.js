...
let apellido = 'Medina'; 
let edad = 27;
let email = 'luis@gmail.com';
let telefono = '5555555555';
let genero = 'Masculino';
let socio = true;
let fechaDelPartido = '05/09/2022';
let horaDelPartido = '19:00';
let ubicacion = ['Alta', 'Media','Baja'];
let numeroDeSilla = 16;
let precioDelBoleto = 15000.25;

//2.- Mostrando el valor de las variables
console.log(dni);
console.log(nombre);
...
//3.- Tipos de dato de cada variable
