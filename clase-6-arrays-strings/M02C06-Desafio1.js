...
let electrodomesticos = ["Televisor", "Lavavajillas", "Horno", "Heladera", "Microondas", "Licuadora"];
...
electrodomesticos.indexOf("Televisor") != -1 ? console.log("Producto encontrado") : console.log("El producto buscado no existe");
electrodomesticos.indexOf("Sandwichera") != -1 ? console.log("Producto encontrado") : console.log("El producto buscado no existe");
